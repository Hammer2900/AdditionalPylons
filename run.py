...
allmaps = ['AutomatonLE', 'BlueshiftLE', 'CeruleanFallLE', 'DarknessSanctuaryLE', 'KairosJunctionLE', 'PortAleksanderLE', 'ParaSiteLE', 'StasisLE'] # all maps

#allmaps = ['BlueshiftLE'] # all maps
