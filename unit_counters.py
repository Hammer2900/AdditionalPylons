...
class UnitCounter:
	...
	def __init__(self):
		...
		self.counterTable = {
			#zerg counters
			'SpineCrawler': [
				[['Phoenix', 0.25], ['Observer', 0.1], ['Immortal', 0.25], ['Adept', 1], ['Stalker', 1], ['Sentry', 0.05], ['Zealot', 1], ['Disruptor', 0.1], ['Colossus', 0.1]],
				[['Phoenix', 0.25], ['Observer', 0.1], ['Immortal', 0.25], ['Adept', 1], ['Stalker', 1], ['Sentry', 0.05], ['Zealot', 1]],
				[['Observer', 0.1], ['Immortal', 0.25], ['Adept', 1], ['Stalker', 1], ['Sentry', 0.05], ['Zealot', 1]],
				[['Adept', 1], ['Stalker', 1], ['Sentry', 0.05], ['Zealot', 1]],
				[['Zealot', 1]],
			],
			...
			#protoss counters
			'Zealot': [
				[['Tempest', 1], ['Observer', 0.25], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 4]],
				[['VoidRay', 1], ['Observer', 0.25], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 4]],
				[['Observer', 0.25], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 4]],
				[['Stalker', 2], ['Sentry', 0.05], ['Zealot', 4]],
				[['Zealot', 4]],
				],
			'Stalker': [
				[['Tempest', 1], ['Observer', 0.25], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 4]],
			...
			#terran counters
			'CommandCenter':[
				[['Tempest', 1], ['Observer', 0.1], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 1], ['Disruptor', 0.1], ['Colossus', 0.1]],
				[['Observer', 0.1], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 1], ['Disruptor', 0.1], ['Colossus', 0.1]],
				[['Observer', 0.1], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 1]],
				[['Stalker', 2], ['Sentry', 0.05], ['Zealot', 1]],
				[['Zealot', 1]],
				],
			'Bunker':[
				[['Tempest', 1], ['Observer', 0.1], ['Immortal', 1], ['Stalker', 2], ['Sentry', 0.05], ['Zealot', 1], ['Disruptor', 0.1], ['Colossus', 0.1]],
